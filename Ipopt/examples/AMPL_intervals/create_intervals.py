...
class AmplSet:
    ...
    def write_opt_file(self):
        ...
        f = open('ipopt.opt', 'w')
        f.write('#file generated by sIpOpt intervallization routine script create_intervals.py -- Ben Waldecker Sep 2012\n\n');
        options = self.create_optionstring(self.branchmode,self.scaling,self.benefits)
        f.write(options)
        f.write('\n\n#end of file\n');
        f.close()

    def create_optionstring(self,bm,sc,bv):
        """
        ...
        return branchmode+scaling+branchvalue
